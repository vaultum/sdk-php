...
/**
 * RecoveryResponse Class Doc Comment
 *
 * @category Class
 * @package  VaultumSDK
 * @author   OpenAPI Generator team
 ...
 */
class RecoveryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecoveryResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['timelock'] === null) {
            $invalidProperties[] = "'timelock' can't be null";
        }
     ...
     * Sets timelock
     *
     * @param \DateTime $timelock timelock
     *
     * @return self
     */
    ...
    {
        if (is_null($timelock)) {
            throw new \InvalidArgumentException('non-nullable timelock cannot be null');
        }
